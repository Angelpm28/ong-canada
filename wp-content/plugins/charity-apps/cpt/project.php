...
function project_post_type() {
    ...
    $labels = array(
        'name' => _x('Project', 'Post Type General Name', 'charity'),
        'singular_name' => _x('Project', 'Post Type Singular Name', 'charity'),
        'menu_name' => __('Project', 'charity'),
        'name_admin_bar' => __('Project', 'charity'),
    ...
    // flush_rewrite_rules();
    register_post_type('charity-project', $args);
}
...
function project_type_taxonomy() {
    ...
    register_taxonomy('project-type', array('charity-project'), $args);
    flush_rewrite_rules();
}
