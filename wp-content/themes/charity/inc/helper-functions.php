 ...
 * @return type
 */
if (!function_exists('the_charity_post_navigation')) :

    function the_charity_post_navigation() {
        // Don't print empty markup if there's nowhere to navigate.
        $previous = ( is_attachment() ) ? get_post(get_post()->post_parent) : get_adjacent_post(false, '', true);
        $next = get_adjacent_post(false, '', false);
        ...
        ?>
        <nav class="charity-post-navigation" role="navigation">
            <div class="nav-links clearfix">
                <?php
                previous_post_link('<div class="nav-previous">%link</div>', 'Preview');
