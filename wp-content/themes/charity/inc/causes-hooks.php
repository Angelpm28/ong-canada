...
class CharityCausesHooks {
    ...
    public function action() {
        ...
        add_action("charity_cauese_donation_progressbar", array(&$this, 'donationProgressbar'));
        add_action("charity_cauese_donation_progressbar_details", array(&$this, 'donationProgressbarDetails'));
        ...
        add_action("charity_causes_post_layout", array(&$this, "charityPostLayout"));
    ...
    function charityPostLayout() {
        $layoutOption = vp_option("vpt_option.charity-causes-layout");

        if ($layoutOption == "gidView") {
            get_template_part("content/causes", "grid-view");
        } else {
            get_template_part("content/causes", "list-view");
        }
    }
...
// for get curreny easy pay 
    ...
    /**
     * Doantion Details - Progress Bar Details
     */
    function donationProgressbarDetails() {
        global $post;
        $target = vp_metabox('doantion-settings.donation-target');
        $achivement = vp_metabox('doantion-settings.donation-achivement');
        $status = vp_metabox('doantion-settings.doantion-status');
