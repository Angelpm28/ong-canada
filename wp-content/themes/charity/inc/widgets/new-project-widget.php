...
/**
 * New Project Post Widgets 
 * @package     charity.inc.widgets
 * @version     v.1.0
 */
class Charity_new_project_widget extends WP_Widget {

    public function __construct() {
        $widget_ops = array('classname' => 'charity_new_project_post', 'description' => __("Charity New Project.", "charity"));
        parent::__construct('new-project', __('Charity New Project', "charity"), $widget_ops);
        $this->alt_option_name = 'charity_new_project_post';
                    ...
                    <?php while ($latestQuery->have_posts()) : $latestQuery->the_post(); ?>
                        ...
                        <li><a href="<?php the_permalink(); ?>" class="pull-left">
                            ...
                            <div class="media-body">
                                <h4>
                                    <a href="<?php the_permalink(); ?>"><?php echo esc_html(charity_truncate_content(get_the_title(), 29)); ?></a></h4>
                                <p><?php echo esc_html(charity_truncate_content(get_the_content(), 60)); ?></p>
...
// Reset the global $the_post as this query will have stomped on it
    ...
    public function update($new_instance, $old_instance) {
        ...
        if (isset($alloptions['charity_new_project_post']))
            delete_option('charity_new_project_post');
...
function charity_new_project_post_widget_init() {
    register_widget('Charity_new_project_widget');
}

add_action('widgets_init', 'charity_new_project_post_widget_init');