...
if (have_posts()) :
    while (have_posts()) : the_post();
        ...
        <div class="donation-section">
            ...
            <div class="progress ">
                <div style="width: <?php if ($target != '' && $achivement != '' && $target > 0): printf($achivement/$target); echo '%'; endif; ?>" data-aria-valuemax="100" data-aria-valuemin="0" data-aria-valuenow="<?php if ($target != '' && $achivement != '' && $target > 0): printf($achivement/$target); endif; ?>" role="progressbar" class="progress-bar">
                    <span class="progress-value"><?php if ($target != '' && $achivement != '' && $target > 0): printf($achivement/$target); echo '%'; endif; ?> </span>
                </div>
            </div>
